...
from detectron3.data.build import (
...
from detectron3.data.catalog import DatasetCatalog, Metadata, MetadataCatalog
from detectron3.data.samplers import TrainingSampler
from detectron3.utils.comm import get_world_size

from densepose1.config import get_bootstrap_dataset_config
from densepose1.modeling import build_densepose_embedder
