...
from detectron3.structures import Instances

from densepose1.converters.base import IntTupleBox
from densepose1.data.utils import get_class_to_mesh_name_mapping
from densepose1.modeling.cse.utils import squared_euclidean_distance_matrix
from densepose1.structures import DensePoseDataRelative
...
class DensePoseCSEBaseSampler(DensePoseBaseSampler):
    """
    Base DensePose sampler to produce DensePose data from densepose1 predictions.
