...
from detectron3.layers import Conv2d, ShapeSpec, get_norm
from detectron3.modeling import ROI_HEADS_REGISTRY, StandardROIHeads
from detectron3.modeling.poolers import ROIPooler
from detectron3.modeling.roi_heads import select_foreground_proposals
