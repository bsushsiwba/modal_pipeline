...
from detectron3.data.transforms import (
    RandomRotation,
    RotationTransform,
    apply_transform_gens,
)
from detectron3.modeling.postprocessing import detector_postprocess
from detectron3.modeling.test_time_augmentation import (
    DatasetMapperTTA,
...
class DensePoseGeneralizedRCNNWithTTA(GeneralizedRCNNWithTTA):
    ...
    # the implementation follows closely the one from detectron3/modeling
