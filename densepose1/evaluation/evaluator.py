...
from detectron3.config import CfgNode
from detectron3.data import MetadataCatalog
from detectron3.evaluation import DatasetEvaluator
from detectron3.structures import BoxMode
from detectron3.utils.comm import gather, get_rank, is_main_process, synchronize
from detectron3.utils.file_io import PathManager
from detectron3.utils.logger import create_small_table

from densepose1.converters import ToChartResultConverter, ToMaskConverter
from densepose1.data.datasets.coco import maybe_filter_and_map_categories_cocoapi
from densepose1.structures import (
