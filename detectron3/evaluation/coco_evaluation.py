...
import detectron3.utils.comm as comm
from detectron3.config import CfgNode
from detectron3.data import MetadataCatalog
from detectron3.data.datasets.coco import convert_to_coco_json
from detectron3.structures import Boxes, BoxMode, pairwise_iou
...
try:
    from detectron3.evaluation.fast_eval_api import COCOeval_opt
except ImportError:
...
class COCOEvaluator(DatasetEvaluator):
    ...
    def _derive_coco_results(self, coco_eval, iou_type, class_names=None):
        ...
        Args:
            coco_eval (None or COCOEval): None represents no predictions from model1.
            iou_type (str):
